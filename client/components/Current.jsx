...
const Current = ({ data }) => {
  ...
  return (
    <div className="relative overflow-hidden">
      <div className="py-8 sm:py-10 md:py-12 px-4 sm:px-6 md:px-8 mx-2 sm:mx-4 md:mx-8 lg:mx-20 my-4 sm:my-6 md:my-8 rounded-3xl sm:rounded-[2rem] backdrop-blur-2xl  shadow-2xl border border-white/30 min-h-[450px] sm:min-h-[500px] lg:min-h-[350px] relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
          <div className="flex flex-col items-center justify-center text-white text-center gap-4 sm:gap-6 lg:flex-shrink-0 lg:w-auto">
            ...
            {/* Weather */}
            <div className="relative">
              <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold text-white/95 break-words max-w-xs leading-relaxed p-4 rounded-2xl backdrop-blur-sm bg-white/10 border border-white/20">
                {text}
              </h3>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center lg:items-start flex-1 w-full max-w-2xl">
            <div className="mb-8 sm:mb-10 md:mb-12 flex flex-col items-center lg:items-start text-center lg:text-left w-full">
              <div className="flex gap-6 items-center mb-5 ">
                ...
                <h2 className="text-xl sm:text-3xl md:text-4xl font-bold text-white/80 tracking-wide">
                  {country}
                </h2>
              ...
              <div className="relative">
                <h4 className="text-lg sm:text-xl md:text-2xl font-bold text-white/96 bg-gradient-to-r from-white/20 to-white/10 px-6 py-3 rounded-2xl backdrop-blur-md border border-white/30 shadow-lg">
                  📅 {localtime}
                </h4>
              </div>
            </div>
